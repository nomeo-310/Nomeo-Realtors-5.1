...
const ForRent = ({searchParams, user}:pageProps) => {
    ...
    <Container className='pt-24 lg:pt-28 min-h-screen'>
      <React.Fragment>
        { searchParams.state ? 
          ...
          <h2 className="lg:text-2xl text-xl text-center">For Rent</h2>
        }
        <div className="flex md:gap-5 lg:gap-7 flex-col md:flex-row gap-3.5 mt-8">
          ...
          <div className='lg:w-[76%] md:w-[70%] w-full'>
            <AllRent searchParams={searchParams} user={user} setIsLoading={setIsLoading}/>
          </div>
        </div>
      </React.Fragment>
    </Container>
